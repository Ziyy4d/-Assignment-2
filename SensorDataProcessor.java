import java.io.*; //added an import for file input {Sultan Alghamdi}

public class SensorDataProcessor { // changed file name to suit the class name {Sultan Alghamdi}

    // Senson data and limits.
    public double[][][] data;
    public double[][] limit;

    // Corrected constructor name {Ziyad Alghamdi}
    public SensorDataProcessor(double[][][] data, double[][] limit) { 
        this.data = data; 
        this.limit = limit; 
    }

    // calculates the average of sensor data {Ziyad Alghamdi}
